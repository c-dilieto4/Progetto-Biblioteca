...
\hypersetup{
    colorlinks=true,
    linkcolor=blue,    % Colore dei link interni (es. Figure, Sezioni)
...
\title{\textbf{Documentazione Architetturale Sistema SGBU}\\Commento ai Diagrammi UML}
\author{}
\date{}
...
\noindent \textit{Per esaminare il Diagramma delle Classi,}\href{https://github.com/c-dilieto4/Progetto-Biblioteca/blob/main/docs/Documentazione%20Design/Diagramma%20delle%20Classi.svg}{\textit{ clicca qui per andare alla figura}.}
...
\noindent \textit{Per esaminare il Diagramma di Sequenza per la Registrazione Prestito,}\href{https://github.com/c-dilieto4/Progetto-Biblioteca/blob/main/docs/Documentazione%20Design/Diagramma%20di%20sequenza%20Registrazione%20Prestito.pdf}{\textit{ clicca qui per andare alla figura}.}

\subsection{Analisi del Flusso e Scelte Progettuali}
...
\noindent \textit{Per esaminare il Diagramma di Sequenza per la Registrazione Restituzione,}\href{https://github.com/c-dilieto4/Progetto-Biblioteca/blob/main/docs/Documentazione%20Design/Diagramma%20di%20sequenza%20Restituzione.pdf}{\textit{ clicca qui per andare alla figura}.}
...
\begin{itemize}
    \item \textbf{it.unisa.sgbu.domain (Dominio):} Il nucleo stabile del sistema. Contiene le entità (\texttt{Libro}, \texttt{Utente}, \texttt{Prestito}) e utility di validazione. È indipendente da tutti gli altri package.
    ...
    \item \textbf{it.unisa.sgbu.gui (Presentazione e Controllo):} Contiene \texttt{GUIView} e \texttt{GUIController}. Agisce da livello superiore orchestrando le interazioni.
